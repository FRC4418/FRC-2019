...
public class OI {
  ...
  public static JoystickButton solenoidButton = new JoystickButton(X3D_RIGHT, 5);
  ...
  public OI(){
    ...
    solenoidButton.whileHeld(new SolenoidOnCommand());
    solenoidButton.whenReleased(new SolenoidOffCommand());
